...
- Long version: [GitLab and SSH Keys](https://docs.gitlab.com/user/ssh/)
- Short version:
  - Open a console, run `ssh-keygen` and follow the instructions to generate your ssh keys pair
  - Run `cat ~/.ssh/id_ed25519.pub` and copy the output to your clipboard
  - Log into [Endava GitLab](https://gitlab.endava.com/-/user_settings/ssh_keys)
  - Navigate to [Profile -> SSH Keys](https://gitlab.endava.com/-/user_settings/ssh_keys)
