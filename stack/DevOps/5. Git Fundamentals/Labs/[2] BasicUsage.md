...
We will simulate working on a new feature for our project. We will do all our work on this **feature/** branch then we will merge it back to **main**.
...
- To merge these changes into main we first need to swap to the main branch, then run the merge command:
